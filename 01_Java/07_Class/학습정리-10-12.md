...
```
	...
	메모리 번지 :  메모리 내용	   // 설명
		2004  :     0 			//width  ,크기4 byte
		2008  :     0 			//height, 크기 4byte
		2012  :   getArea()		//함수 주소,크기 4byte 
		2016  :   getWidth()	//함수 주소,크기 4byte 
		2020  :   setWidth() 	//함수 주소,크기 4byte 
		2024  :   getHeight() 	//함수 주소,크기 4byte 
		2028  :   setHeight()	//함수 주소,크기 4byte 
